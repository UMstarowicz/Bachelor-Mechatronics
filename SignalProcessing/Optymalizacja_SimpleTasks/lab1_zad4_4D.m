...
for k = 301:600
 ...
 F1 = F.Data(k).Normal.Moments.M11;
 F2 = F.Data(k).Normal.Area; 
 F3 = F.Data(k).Normal.Moments.M30;
 F4 = F.Data(k).Normal.HuInvariants.I0; 
...
ErrorsF = ErrorsF + 1;
 ...
 F1 = T.Data(k).Normal.Moments.M11;
 F2 = T.Data(k).Normal.Area;
 F3 = T.Data(k).Normal.Moments.M30;
 F4 = T.Data(k).Normal.HuInvariants.I0;
