...
for k = 301:600
 ...
 if(ClassifierKNN_K([F1,F2,F3,F4],TrainingDataClass0,TrainingDataClass1) == 1) % Detected class "1" 
ErrorsF = ErrorsF + 1;
 ...
 if(ClassifierKNN_K([F1,F2,F3,F4],TrainingDataClass0,TrainingDataClass1) == 0) % Detected class "0 
ErrorsT = ErrorsT + 1;
